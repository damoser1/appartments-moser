        ...
        <div class="h-full rounded-2xl border border-gray-100 bg-white px-6 xl:pt-4 pb-6 shadow-sm hover:shadow-md transition">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm mt-1">1 Galerie-Schlafzimmer + Schlafsofa, insgesamt 4 Schlafplätze.</p>
                </div>
            </div>
        </div>
        ...
        <div class="h-full rounded-2xl border border-gray-100 bg-white px-6 pt-4 pb-6 shadow-sm hover:shadow-md transition">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm mt-1">Mit Dusche, Whirlpool-Badewanne & Sauna für maximale Entspannung.</p>
                </div>
            </div>
        </div>
        ...
        <div class="h-full rounded-2xl border border-gray-100 bg-white px-6 pt-4 pb-6 shadow-sm hover:shadow-md transition">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-sm mt-1">Herd, Backofen, Geschirrspüler, Kaffeemaschine, Toaster & mehr.</p>
                </div>
            </div>
        </div>
            ...
            <div class="feature-extra hidden sm:block h-full rounded-2xl border border-gray-100 bg-white px-6 pt-4 pb-6 shadow-sm hover:shadow-md transition">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 text-sm mt-1">Privater Außenbereich mit Gartenmöbeln, Liegen & Grill.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="feature-extra hidden sm:block h-full rounded-2xl border border-gray-100 bg-white px-6 pt-4 pb-6 shadow-sm hover:shadow-md transition">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 text-sm mt-1">Schnelles WLAN, Smart-TV mit Netflix. Bettwäsche & Handtücher inklusive.</p>
                    </div>
                </div>
            </div>
