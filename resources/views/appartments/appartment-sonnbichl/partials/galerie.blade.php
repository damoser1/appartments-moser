@php
    // Demo-Bilder
    $images = array_fill(0, 12, asset('assets/bildtransparent.png'));

    // Anzahl, die vor dem Pfeil (2 Reihen) angezeigt wird:
    $initialCount = 8; // 2 Reihen à 4 (lg) – responsive passt trotzdem
@endphp
...
<section id="galerie" class="relative bg-white py-16">
    ...
    <div class="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div class="text-center mb-10">
            <h1 class="text-3xl sm:text-4xl font-extrabold text-brand-charcoal">Galerie</h1>
            <p class="mt-3 text-gray-700 max-w-2xl mx-auto">
                Einblicke in das <span class="font-semibold">Appartement Sonnbichl</span> – Demo-Bilder werden durch echte Fotos ersetzt.
            </p>
        </div>
